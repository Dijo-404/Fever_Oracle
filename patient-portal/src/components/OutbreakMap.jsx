...
import { INDIA_REGIONS, INDIA_CENTER } from '../lib/indiaRegions.js'
...
const getFeverTypeColor = (feverType) => {
  const colors = {
    Dengue: '#FF0000',
    Malaria: '#0000FF',
    Typhoid: '#00FF00',
...
export const OutbreakMap = ({ selectedFeverType, onRegionClick, height = '600px' }) => {
